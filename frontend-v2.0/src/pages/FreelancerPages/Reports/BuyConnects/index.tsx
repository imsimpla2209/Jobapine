  ...
  const handleBuyViaBalance = () => {
    ...
    handleBuySick()
      .then(res => {
        ...
        toast.success(`${t('Successfully')} ${t('Buy SickPoints Payment', { amount: buy })} ${t(
          'Pay a fixed price'
  ...
  return (
    <div style={{ padding: '20px 100px' }}>
      ...
      >
        ...
        <Space align="baseline" className="mb-0 pt-3" style={{ width: '100%' }}>
          <h4 className="para">{t('Your new SickPoints balance will be')}:</h4>
          <span style={{ fontSize: 18, fontWeight: 600 }}>{state?.sickPoints + buy} SickPoints</span>
        </Space>
