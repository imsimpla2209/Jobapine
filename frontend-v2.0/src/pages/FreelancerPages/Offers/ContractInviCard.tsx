...
export default function ContractInviCard({ invitation, getOffers, user, onRefresh, setTab }) {
  ...
  return (
    ...
    <div className="col-11 mx-auto border border-gray rounded ps-3 pe-5 pt-2 pb-5 mb-4 text-center" style={{
      background: '#f1e3ff',
      position: 'relative'
    }}>
        ...
        <div>
          ...
          <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col xl={12} xs={24}>
              ...
              <p><strong>{t("Description")} {t("Invitation")}: </strong>{pickName(invitation?.content?.content, i18n.language)}</p>
              ...
              <p><strong>{t("Posted Date")} - {t("Invitation")}: </strong>{new Date(invitation?.createdAt).toLocaleString()}</p>
            </Col>
            <Col xl={12} style={{ padding: 8, border: '1px solid #ccc', borderRadius: 8, marginBottom: 8, background: 'white' }}>
