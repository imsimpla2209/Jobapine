            ...
            isResubmit ? (
              <>
                ...
                <div className="ps-4 py-2">
                  {user.sickPoints > appInfo?.freelancerSicks?.updateProposalCost ? (
                    <>
                      <p>
                        {t('This proposal requires')}{' '}
                        <strong>{appInfo?.freelancerSicks?.updateProposalCost} Sick Points </strong>
                      ...
                      <p>
                        ...
                        <strong> {user.sickPoints - appInfo?.freelancerSicks?.updateProposalCost} Sick Points </strong>
                        {t('remaining')}
                      </p>
                    </>
                  ) : (
