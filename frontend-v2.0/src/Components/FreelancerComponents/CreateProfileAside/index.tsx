			...
			<ul>
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 1}>
						...
						>
							<span className="text-dark"><i className="fas fa-list-alt mx-4"></i>{t("Categories")}</span>
				...
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 2}>
						...
						>
							<span className="text-dark"><i className="fas fa-signal mx-4"></i>{t("Expertise")}</span>
				...
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 4}>
						...
						>
							<span className="text-dark"><i className="fas fa-language mx-4"></i>{t("Languages")}</span>
				...
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 5}>
						...
						>
							<span className="text-dark"><i className="fas fa-search-dollar mx-4"></i>{t("Expected Amount")}</span>
				...
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 8}>
						...
						>
							<span className="text-dark"><i className="fas fa-map-marker-alt mx-4"></i>{t("Location")}</span>
				...
				<li className="py-1 my-2">
					<button className="btn w-100" disabled={step < 9}>
						...
						>
							<span className="text-dark"><i className="fas fa-phone-alt mx-4"></i>{t("Phone")}</span>
