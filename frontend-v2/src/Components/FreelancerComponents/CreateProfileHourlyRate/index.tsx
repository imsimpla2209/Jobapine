...
export default function CreateProfileHourlyRate({ setBtns, btns }) {
  ...
  const addRate = () => {
    console.log(rate);
    updateUserData("freelancer", { hourlyRate: rate, profileCompletion: 60 });
      ...
      <div className="p-4 my-3">
        ...
        <div>
          ...
          <div className="mb-3 d-flex justify-content-between border-top pt-3">
            <div>
              <span>
                <strong>JobSickers Service Fee</strong>
                <a className="upw-c-cn fw-normal ms-3" href="">
                  Explain this
                </a>
              </span>
              <p className="w-75">
                The JobSickers Service Fee is 20% when you begin a contract with a
