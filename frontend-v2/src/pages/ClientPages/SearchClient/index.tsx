        ...
        <div className="row border bg-white border-1 px-3 py-3" key={item.authID}>
          ...
          <div className="col py-3">
            <div className="btn-group float-end ">
              ...
              >
                <i onClick={(e) => saveFreelancer(e, item.authID)} className={`${client?.savedFreelancers?.includes(item.authID) ? 'fas fa-heart text-jobsicker' : 'far fa-heart'}`} aria-hidden="true" />
              </button>
            </div>
          </div>
