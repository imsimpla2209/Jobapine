      ...
      <div className="row bg-white border border-rounded border-1 bg-gray mx-3">
        <div className="row p-5">
          ...
          <div className="col-3">
            ...
            <span className="h4 ms-3">{data?.client?.name}</span>
        ...
        <div className="row px-5">
          <ul className="nav nav-tabs ">
            <li className="nav-item">
              <NavLink className={isActive => ('nav-link' + isActive.isActive ? 'active' : '')} to="/contract">
                Earnings
              </NavLink>
            </li>
            <li className="nav-item ">
              <NavLink className={isActive => ('nav-link' + isActive.isActive ? 'active' : '')} to="/contract/feedback">
                Feedback
              </NavLink>
            </li>
          ...
          <Routes>
            <Route
              path="/contract"
              element={<ContractEarnings job={data?.job} client={data?.client} clientContract={data?.client} />}
            ></Route>
            <Route path="/contract/feedback" element={<ContractFeedback job={data?.job} />}></Route>
          </Routes>
        </div>
      </div>
    </div>
