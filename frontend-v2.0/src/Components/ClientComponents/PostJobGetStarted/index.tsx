      ...
      </div>
      {
        !start
          ...
          <div className="ps-4 my-3">
            <button className="btn bg-jobsicker" onClick={createJob}>{t("Get Start")}</button>
          </div>
          :
          <>
            <div className="ps-4 my-3">
            ...
            <div className="ps-4 my-3">
              ...
              <button className={`btn ${job.jobDuration === "" ? "disabled" : ""}`}>
                <Link className="btn bg-jobsicker px-5" to="/post-job/title" onClick={addData}>{t("Continue")}</Link>
              </button>
            </div>
          </>
      }
