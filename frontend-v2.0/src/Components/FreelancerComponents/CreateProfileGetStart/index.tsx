    ...
    return (
        <section className=" bg-white border rounded mt-3 pt-4">
            ...
            <div className="px-4 mt-3">
                <p className="fw-bold mt-2">To provide a high quality experience to all customers, admission to JobSickers is highly competitive.</p>
                <div className="my-4">
                ...
                <div className="my-4 text-end">
                    <Link className="btn bg-jobsicker" to="/create-profile/category" onClick={() => setBtns({ ...btns, category: false })}>Start My Profile</Link>
                </div>
            </div>
        </section>
    )
