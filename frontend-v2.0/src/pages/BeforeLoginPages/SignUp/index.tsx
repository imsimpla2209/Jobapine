    ...
    <div style={{ height: '100vh' }}>
      ...
      <div className="container-fluid bg-jobsicker-dark mb-auto" style={{ padding: '20vh' }}>
        <div className="row">
          ...
          {
            userInfo.lastLoginAs === 'Freelancer' ? <FreelancerRegisterModal isOpen={step === ESignupStep.INFO} onClose={onCloseInfoForm} setWorkInfo={setWorkInfo} workInfo={workInfo} />
              : <ClientRegisterModal isOpen={step === ESignupStep.INFO} onClose={onCloseInfoForm} setWorkInfo={setWorkInfo} workInfo={workInfo} />
          }
        </div>
      </div>
      <SignupFooter />
