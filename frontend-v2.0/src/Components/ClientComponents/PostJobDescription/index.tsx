    ...
    <section className=" bg-white border rounded mt-3 pt-4">
      ...
      <div className="mx-4 mt-5 py-2 pb-4">
        ...
        <div className="d-flex mb-3">
          {
            ...
            job.jobImages.map((url, ix) => {
              return <div className="mx-2 circle" style={{ width: "50px", height: "50px" }} key={ix}>
        ...
        <div className="attachments-cn">
          <p className="py-2 text-center mt-2">
            <label htmlFor="file" className="upw-c-cn me-1" style={{ cursor: "pointer" }}>{t("upload")}</label>
      ...
      <div className="ps-4 my-3 pt-4 pb-3 pt-3 border-top">
        ...
        <button className={`btn ${job.jobDescription === "" && "disabled"}`}>
          <Link className="btn bg-jobsicker px-5" to="/post-job/details" onClick={addData}>{t("Next")}</Link>
        </button>
      </div>
    </section>
  )
