...
export default function AddLanguage(props) {
    return (
        <>
            ...
            <button type="button" className="btn border border-success rounded-pill col-6 text-success" onClick={props.toggleAddLang}><i className="fas fa-plus"></i> Add Language</button>
            <ul>
