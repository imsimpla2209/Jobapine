...
import freelancerMainSectionClientUseJobSickersDevIT from '../../../assets/img/talent-main-section-client-use-upwork-Dev-IT.png'
import freelancerMainSectionClientDeveloperDev from '../../../assets/img/talent_main-section-client-developer-Dev-IT.jpeg'
      ...
      <div className="row mx-lg-5 mx-1 my-5 py-5">
        ...
        Budget:$14,520</span>
          ...
          <div className="row my-3 fs-md-5 fs-6 ms-0 mb-3 text-secondary" id="Project-Examples-paragraph-ID">
            "Yevhenii is a freelancered designer! We also had him manage a front-end
        ...
        <div className="col-5 position-relative">
          <img className="position-absolute " id="client-ID" src={freelancerMainSectionClientUseJobSickersDevIT} alt='' />
          <div className="col-5 px-3 py-2 position-absolute bottom-0 start-0 bg-white" id="client-dev-ID">
            <div className="row d-none d-lg-flex justify-content-between">
              <div className="col-3">
                <img className="d-inline-block px-0 rounded-circle border border-2 border-white" id="projected-by-Dev-ID" src={freelancerMainSectionClientDeveloperDev} alt='' style={{ zIndex: 2, left: '-40px' }} />
              </div>
              <div className="col-7 ">
