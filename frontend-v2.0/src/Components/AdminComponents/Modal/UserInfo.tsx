...
import { Avatar, Button, Card, Col, Descriptions, Input, Modal, Popconfirm, Progress, Rate, Row, Space, Switch } from "antd"
...
const UserInfo = ({ user, type }: any) => {
  ...
  const [verified, setVerified] = useState(type === EUserType.FREELANCER ? user?.isProfileVerified : user?.paymentVerified)
