  ...
  return (
    <section className="bg-white border rounded mt-3 pt-4">
      ...
      <div className="px-4 my-3 pt-4 border-top d-flex justify-content-between">
        <button
          className="btn border me-4 px-5 fw-bold"
        ...
        {
          isVerified ? (
            <button className={`btn bg-jobsicker px-5 ${value && isVerified && !validate ? "" : "disabled"}`} onClick={getNumber}>
              {t("Review profile")}
            </button>
          ) : (
