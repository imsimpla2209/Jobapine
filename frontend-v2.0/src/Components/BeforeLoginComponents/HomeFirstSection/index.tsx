				...
				<div className="row">
					<div className="col-md-6 col-sm-12">
						<div>
							...
							<div className="my-5">
								<Link className="btn py-3 px-4 me-4 fs-btns-cn text-decoration-none" to="/freelance-jobs">{t("FindFreelancer")}</Link>
								<button className={`btn py-3 px-4 border text-success ${lang === 'vi' && "fs-6"}`}>{t("FindWork")}</button>
							</div>
