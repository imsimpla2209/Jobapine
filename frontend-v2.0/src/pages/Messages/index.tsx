  ...
  return (
    <div className="">
      <div className="row pt-3">
        <aside className="col-12 col-md-3 d-flex" style={{
          display: 'flex',
              ...
              messageRoomsByUser?.map((item, index) => (
                <div
                  ...
                  style={{
                    padding: 14,
                    cursor: 'pointer',
                    borderLeft: selectedUserMessages?.memberId?.id === item?.memberId?.id ? '6px solid #6600cc' : 'none',
        ...
        <div className="col-sm-12 col-md-9">
          <MesssagesContent setSelectedMessageRoom={setSelectedMessageRoom} userID={user?.state?._id || user?.state?.id} selectedMessageRoom={selectedMessageRoom} member={selectedUserMessages?.memberId} />
        </div>
      </div>
    </div>
  )
