...
import freelancerMainSectionExperts1DevIT from '../../../assets/img/talent_main-section-experts1-Dev-IT.jpeg'
import freelancerMainSectionExperts2DevIT from '../../../assets/img/talent_main-section-experts2-Dev-IT.jpeg'
import freelancerMainSectionExperts3DevIT from '../../../assets/img/talent_main-section-experts3-Dev-IT.jpeg'
            ...
            <div className="row mx-md-5 mx-1 my-md-5 my-3 py-md-5" id="Remote-professionals-section-ID">
                ...
                <div className="row mb-3" id="evaluation-ID">
                    ...
                    <div className="col-lg-3 col-md-4 mb-3">
                        <EvaluationCard header="1,665 skills" content=" Represented across JobSickers's pool of development and IT freelancer" />
                    </div>
                </div>
                <div className="d-flex flex-lg-wrap flex-row flex-nowrap overflow-auto mx-1 mb-3" id="scrollable-experts-ID">
                    <div className="col-lg-3 col-md-5 col-6 px-3 shadow-sm rounded-3 py-3 mb-2">
                        <ExpertsCard expert1={freelancerMainSectionExperts1DevIT} expert2={freelancerMainSectionExperts2DevIT} expert3={freelancerMainSectionExperts3DevIT} />
                    </div>
                    <div className="col-lg-3 col-md-5 col-6 px-3 shadow-sm rounded-3 py-3 mb-2">
                        <ExpertsCard expert1={freelancerMainSectionExperts1DevIT} expert2={freelancerMainSectionExperts2DevIT} expert3={freelancerMainSectionExperts3DevIT} />
                    </div>
