...
export default function PleaseVerifiy() {
  ...
  return (
    <div className="text-center" style={{ margin: "67px 0" }}>
      ...
      {/* <Link className="d-block text-success py-3"><i className="fas fa-chevron-circle-down px-2 "></i>Change Email</Link>
      <Link className="d-block text-success py-3"><i className="fas fa-chevron-circle-down px-2 "></i>I need help verifing my email</Link> */}
      <button className="btn bg-jobsicker mt-4 rounded-pill px-5 py-2" onClick={handleResend}>
