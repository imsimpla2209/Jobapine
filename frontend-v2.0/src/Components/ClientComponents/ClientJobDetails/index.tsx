...
export default function ClientJobDetails({ job }) {
    ...
    <div style={{ display: 'grid', gap: 16 }}>
      <Card>
        ...
        {job?.description ? (
          <>
            ...
            <Row>
              <Text className="text-muted">{job?.description}</Text>
            </Row>
          </>
        ) : null}
      </Card>
      ...
      <Card>
        <div style={{ display: 'grid', gap: 10 }}>
          ...
          {job?.preferences?.locations?.length ? (
            <Row>
              <Space size={'middle'} align="baseline" wrap>
      ...
      <Card>
        <ul className="row list-group list-group-horizontal">
          ...
          <li className="col list-group-item border-0">
            ...
            <small className="text-muted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{t(`${job?.payment?.type}`)}</small>
          </li>
          {/**/}
          <li className="col list-group-item border-0">
            <div className="header">
            ...
            <small className="text-muted">
              <span className="d-none d-lg-inline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{t('Experience Level')}</span>{' '}
            </small>
          </li>
          ...
          <li className="col list-group-item border-0">
            ...
            <small className="text-muted">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{t(`Freelancersneeded`)}</small>
          </li>
        </ul>
      </Card>
