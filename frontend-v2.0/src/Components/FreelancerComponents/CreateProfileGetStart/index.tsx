	...
	return (
		<section className=" bg-white border rounded mt-3 pt-4">
			...
			<div className="px-4 mt-3">
				<p className="fw-bold mt-2">{t("To provide a high quality experience to all customers, admission to JobSickers is highly competitive.")}</p>
				<div className="my-4">
					...
					<p>{t("We are currently experiencing a high number of applications. Create a stand-out profile to increase your chances of getting approved!")}</p>
				</div>
				<div className="my-4 text-end">
					<button className="btn bg-jobsicker" onClick={() => {
