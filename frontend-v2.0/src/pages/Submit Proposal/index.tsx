...
export default function SubmitProposal() {
  ...
  const handleProposal = () => {
    ...
    // );
    // updateUserData("freelancer", { connects: user.connects - 2 });
                ...
                <div className="ps-4 pt-2 d-flex">
                  <div className="w-75">
                    ...
                    <div className="mb-3">
                      <span className="bg-cat-cn py-1 px-2 me-3 rounded-pill">
                        {lang === 'vi' ? job?.jobCategory : job?.jobCategory}
                      </span>
                      <span>
                        {new Date(
                    ...
                    <div className="mb-3">
                      ...
                      <Link to='' onClick={(e) => { e.stopPropagation(); e.preventDefault(); navigate(`/job/${id}`, { state: { id } }) }} className="upw-c-cn">
                        View job posting
                      </Link>
                    </div>
                  </div>
                  <div className="w-25 border-start m-3 ps-3">
                    <div>
                      ...
                      <p className="ps-4">{lang === 'vi' ? job?.jobExperienceLevel : job?.jobExperienceLevel}</p>
                    </div>
                    <div>
                      <span>
                      ...
                      <p className="ps-4">{lang === 'vi' ? job?.jobPaymentType : job?.jobPaymentType}</p>
                    </div>
                    <div>
                      <span>
                      ...
                      <span className="ps-2">
                        <strong>{lang === 'vi' ? job?.jobDuration : job?.jobDuration}</strong>
                      </span>
              ...
              <div className="bg-white border rounded-bottom rounded-top">
                ...
                <div className="mx-4 mt-3 py-2 pb-4">
                  ...
                  <div className="d-flex mb-3">
                    {
                      ...
                      proposalData?.proposalImages.map((url, ix) => {
                        return (
                          <div
                            key={ix}
                            className="mx-2"
                  ...
                  <p className="my-3">
                    ...
                    résumé — your JobSickers profile is automatically forwarded to
                    ...
                    <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                      <div className="modal-content">
                        ...
                        <div className="modal-footer">
                          <button
                            type="button"
                            className="btn bg-jobsicker-dark rounded border-dark text-white"
                            data-bs-dismiss="modal"
